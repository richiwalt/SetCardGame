...
struct Theme {
    ...
    // theme ColorGradients for background
        ...
        [ Color( #colorLiteral(red: 0.30980392156862746, green: 0.01568627450980392, blue: 0.12941176470588237, alpha: 1.0) ), Color( #colorLiteral(red: 0.5725490196078431, green: 0.0, blue: 0.23137254901960785, alpha: 1.0) ), Color( #colorLiteral(red: 0.807843137254902, green: 0.027450980392156862, blue: 0.3333333333333333, alpha: 1.0) ), Color( #colorLiteral(red: 0.8549019607843137, green: 0.25098039215686274, blue: 0.47843137254901963, alpha: 1.0) )],
        [ Color( #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1) ), Color( #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1) ), Color( #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1) ), Color( #colorLiteral(red: 0.8039215803, green: 0.8039215803, blue: 0.8039215803, alpha: 1) )],
        ...
        [ Color( #colorLiteral(red: 0.12156862745098039, green: 0.011764705882352941, blue: 0.4235294117647059, alpha: 1.0) ), Color( #colorLiteral(red: 0.17647058823529413, green: 0.011764705882352941, blue: 0.5607843137254902, alpha: 1.0) ), Color( #colorLiteral(red: 0.2196078431372549, green: 0.00784313725490196, blue: 0.8549019607843137, alpha: 1.0) ), Color( #colorLiteral(red: 0.36470588235294116, green: 0.06666666666666667, blue: 0.9686274509803922, alpha: 1.0) )],
        [ .orange, .yellow, .green, .blue, .purple],
    ]
     
    init() {
        self.colorGradient = colorGradients[0]
    }
    
    mutating func loadNext() {
        nextColorIndex = nextColorIndex == colorGradients.endIndex - 1 ? 0 : nextColorIndex + 1
        colorGradient = colorGradients[nextColorIndex]
    }
